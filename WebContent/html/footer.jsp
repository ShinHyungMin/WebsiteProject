...
<br>
	<div class="frame">
		...
		<div class="footer-division-2">
			<div class="footer-text">회사명 : (주)0000 | 대표이사:000 | 사업자등록번호:000-00-00000 | 호스팅사업자:(주)000</div>
			<div class="footer-text">주소 : (00000) 서울특별시 강남구</div>
			<div class="footer-text">개인정보관리책임자 : 000</div>
			<div class="footer-link-company">
				...
				<span class="footer-sep">  |  </span>
					<a href="mainList.do" style="color: blue;">관리자 페이지</a>
				</c:if>
			</div>
		</div>		
	</div>
