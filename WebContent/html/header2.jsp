...
<head>
	<meta charset="UTF-8">
	<title>header2</title>
	<link href="${pageContext.request.contextPath}/css/NewFile2.css" rel="stylesheet">
...
<ul>
	...
	<li><a href="thirdPage.jsp">아우터</a>
		<ul class="sub">
			...
			<li><a href="searchMain.do?keyword=패딩">패딩</a></li>
		</ul>
	</li>
	...
	<li><a href="thirdPage.jsp">하의</a>
		<ul class="sub">
			<li><a href="searchMain.do?keyword=청바지">청바지</a></li>
			<li><a href="thirdPage.jsp">트레이닝</a></li>
			<li><a href="searchMain.do?keyword=반바지">반바지</a></li>
			<li><a href="searchMain.do?keyword=슬랙스">슬랙스</a></li>
		</ul>
	</li>	
