...
@WebServlet("/noticeListM.do")
public class NoticeListMServlet extends HttpServlet {
...
//		System.out.println(productList.get(1));
		...
		// 리스트 페이지 이동
		RequestDispatcher dispatcher = request.getRequestDispatcher("./manager/board/notice.jsp");
